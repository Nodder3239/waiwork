(function(){
    var _waiDefaults = function() {
        ...
        this.dateSeparator = '/';
        this.getDateFormat = 'yyyymmdd'; //dd-mm-yyyy
        this.arbitrary_precision = true; // arbitrary-precision arithmetic. (true: string, false: number)
        this.grid_CheckEditValue = [ 'True' , 'False' ];
        this.grid_CheckEditValueIgnorecase = true;
        ...
        this.cbInputUppercase = false; // <codecombo> input field 대문자 적용
        this.cbMskFormatUppercase = true;   // <codecombo> MskFormat 사용시 input field 대문자 적용 > BEST 프로젝트에서만 사용 (정규식이아니어서)
        this.edit_maskDefValOnBlur = false;
        this.edit_getCurrencyEmptyVal = false; // true : '', false : '0.00' or 0
        this.dateLang = 'EN';
        this.dateLangData = {
            'EN' : { // English
                weeks: ['S', 'M', 'T', 'W', 'T', 'F', 'S']
